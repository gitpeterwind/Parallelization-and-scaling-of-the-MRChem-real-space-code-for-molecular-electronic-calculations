...
%could also show how much time is used for matrix mult compared to transfer time
...
In MRA method, the precision is chosen as a single number that can be chosen on a continuous scale. The resulting precision will be independent of the property of interest. %is this true?
